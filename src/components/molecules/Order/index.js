...
const Order = (props) =>{
    ...
    <Text style={{paddingLeft:'25%',paddingTop:'2%',color:'black',fontWeight:'700',fontSize:16}}>{props.tittle}</Text>
            ...
            <View style={{ flexDirection: 'row',justifyContent: 'space-between',marginTop:10}}>
                ...
                <View style={{backgroundColor:'#d4d4d4',marginBottom:'5%',marginTop:'5%',justifyContent:'flex-end',borderRadius:10,height:35,width:95,flexDirection:'row'}}>
                    <Text style={{fontSize:40,color:'#24972B',fontWeight:'bold',bottom:11,textAlign:'center'}}>- </Text>
                    <Text style={{fontSize:20,color:'black',fontWeight:'bold',top:3,textAlign:'center'}}> 6 </Text>
                    <Text style={{paddingRight:'8%',paddingLeft:'1%',fontSize:25,color:'#24972B',fontWeight:'bold',top:1,textAlign:'center'}}> + </Text>
                </View>
            </View>
